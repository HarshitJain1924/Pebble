...
export const isOverdue = (todo: Todo, selectedDate: string) => {
...
export let globalLists: TaskList[] | null = null;
export let globalTodos: Record<string, Todo[]> | null = null;
export let globalHabits: Habit[] | null = null;
export let globalCollections: Record<string, Collection[]> | null = null;
export let globalChecklists: Record<string, Checklist[]> | null = null;

export function setGlobalLists(val: TaskList[] | null) { globalLists = val; }
export function setGlobalTodos(val: Record<string, Todo[]> | null) { globalTodos = val; }
export function setGlobalHabits(val: Habit[] | null) { globalHabits = val; }
export function setGlobalCollections(val: Record<string, Collection[]> | null) { globalCollections = val; }
