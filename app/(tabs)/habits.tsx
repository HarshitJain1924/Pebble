...
import { HabitsEmptyGraphic } from "@/shared/components/ui/AppGraphics";
...
import { type Habit as SharedHabit } from "@/shared/types/domain.types";
...
export function HabitsScreen() {
  ...
  const toggleHabit = async (id: string) => {
    ...
    try {
      const { handleHabitXpChange } = require("@/features/settings/services/settings.service");
...
export const DailyScreen = HabitsScreen;
