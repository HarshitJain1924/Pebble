...
export const CaptureKindColors: Record<CaptureKind, ColorPair> = {
  task: both(Palette.indigo500), // #6366F1
...
export const CaptureCategoryColors: Record<CaptureCategory, ColorPair> = {
  ...
  focus: both(Palette.indigo500), // #6366F1
};
...
> = {
  ...
  focus: { color: both(Palette.indigo400), tint: both("rgba(129, 140, 248, 0.12)") },
};
...
export const PebbleTypeColors: Record<PebbleType, ColorPair> = {
  task: both(Palette.indigo400), // #818CF8
...
export const DefaultWorkspaceColor: ColorPair = both(Palette.indigo500); // #6366F1
