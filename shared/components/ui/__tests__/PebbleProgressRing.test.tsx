...
import { PebbleProgressRing, getActivePebbleCount } from "../PebbleProgressRing";

describe("PebbleProgressRing and getActivePebbleCount", () => {
  ...
  describe("Edge cases for count and non-finite inputs", () => {
    ...
    it("safely handles NaN and Infinity", () => {
  ...
  describe("PebbleProgressRing Component Rendering", () => {
    it("mounts correctly and renders pebble units", () => {
      let renderer: any;
      act(() => {
        renderer = create(
          <PebbleProgressRing progress={0.5} size={160} strokeWidth={8} showText={false} />
        );
      });
    ...
    it("renders percentage text when showText is true", () => {
      ...
      act(() => {
        renderer = create(
          <PebbleProgressRing progress={0.5} size={160} strokeWidth={8} showText={true} />
        );
      });
