...
jest.mock("@/features/resources/hooks/useResourceState", () => ({ useResourceState: () => ({ resources: {}, setAllResources: jest.fn(), loadResourcesState: jest.fn(async () => undefined), createResource: jest.fn(), updateResource: jest.fn(), deleteResource: jest.fn(), toggleArchiveResource: jest.fn() }) }));
